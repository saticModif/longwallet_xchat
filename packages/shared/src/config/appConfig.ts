/*
 * @Author: baoJT
 * @Date: 2025-01-12 02:00:16
 * @LastEditTime: 2025-01-19 01:17:15
 */
...
export const NODEIUM_API_HOST = 'nodeium.onekey.so';

// http://wallet.66kuaifa.com/api/bus/Notice
...
export const buildServiceEndpoint = ({
  ...
  `${isWebSocket ? 'wss' : 'https'}://${serviceName}.${env === 'prod' ? ONEKEY_API_HOST : ONEKEY_TEST_API_HOST
  }`;

export const CHAIN_SELECTOR_LOGO =
  'https://uni.onekey-asset.com/static/logo/chain_selector_logo.png';

export const CUSTOM_NETWORK_URL = 'https://xchatviewapi.33test.com';
export const CUSTOM_APP_NAME = 'lspayWallet';
