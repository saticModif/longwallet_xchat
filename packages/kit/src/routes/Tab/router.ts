...
import { ModalSettingStack } from '../../views/Setting/router';
      ...
      [
        {
          ...
          imageSource: (focused?: boolean) =>
            focused
              ? require('@onekeyhq/kit/assets/wallet_active.png')
              : require('@onekeyhq/kit/assets/wallet_inactive.png'),
       ...
       
        {
          ...
          imageSource: (focused?: boolean) =>
            focused
              ? require('@onekeyhq/kit/assets/market_active.png')
              : require('@onekeyhq/kit/assets/market_inactive.png'),
        ...
        isShowMDDiscover ? getDiscoverRouterConfig(params) : undefined,
        {
          ...
          imageSource: (focused?: boolean) =>
            focused
              ? require('@onekeyhq/kit/assets/switchhor_active.png')
              : require('@onekeyhq/kit/assets/switchhor_inactive.png'),
        ...
        platformEnv.isDev
          ? {
              ...
              imageSource: (focused?: boolean) =>
                focused
                  ? require('@onekeyhq/kit/assets/my_active.png')
                  : require('@onekeyhq/kit/assets/my_inactive.png'),
