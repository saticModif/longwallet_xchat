...
export function AmountInput({
  ...
  const TokenSelectorTrigger = useMemo(() => {
    ...
    const USDICON = 'https://uni.onekey-asset.com/server-service-indexer/tron--0x2b6653dc/tokens/address-TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t-1720668500740.png'
      ...
      >
        <Stack mr="$2">
          <Image height="$7" width="$7" borderRadius="$full">
            <Image.Source
              source={{
                uri: tokenSelectorTriggerProps?.selectedTokenSymbol == "ISPAY" ? ispayIcon : tokenSelectorTriggerProps?.selectedTokenSymbol == "USDT" ? USDICON : tokenSelectorTriggerProps?.selectedTokenImageUri,
              }}
            />
            <Image.Fallback
              alignItems="center"
          ...
          {!(tokenSelectorTriggerProps?.selectedNetworkImageUri)&&tokenSelectorTriggerProps?.isCustomNetwork &&
