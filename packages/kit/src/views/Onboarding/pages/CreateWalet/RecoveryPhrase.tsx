...
export function RecoveryPhrase() {
  ...
  return (
    <Page scrollEnabled>
      ...
      />
      <Page.Body p="$5" pt="$0">
        <SizableText pt="$2" pb="$4" px="$1">
          {intl.formatMessage({
            id: ETranslations.onboarding_backup_recovery_phrase_help_title,
          })}
        </SizableText>
        <SizableText pb="$4" px="$1" color="$textSubdued" size="$bodyMd">
          {intl.formatMessage({
        ...
        <TouchableOpacity onPress={() => copyText(mnemonic)}>
          <SizableText
            textAlign="center"
            pt="$6"
            pb="$2"
          ...
          >
            {intl.formatMessage({
              id: ETranslations.onboarding_backup_recovery_phrase_copy_text,
            })}
          </SizableText>
        </TouchableOpacity>
      </Page.Body>
