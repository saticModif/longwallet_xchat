...
import { EarnHeaderRight } from './EarnHeaderRight';
...
function BasicMyHome() {
  ...
  const INTRODUCTION_ITEMS: {
  ...
  }[] = [
    {
      icon: 'BookOutline',
      title: intl.formatMessage({
        id: ETranslations.my_address_book,
      }),
    },
    {
      icon: 'GiftOutline',
      title: intl.formatMessage({
        id: ETranslations.my_invite,
      }),
    },
    {
      icon: 'InfoCircleOutline',
      title: intl.formatMessage({
        id: ETranslations.my_about,
      }),
    },
    {
      icon: 'SettingsOutline',
      title: intl.formatMessage({
        id: ETranslations.my_settings,
      }),
    },
  ];
  const renderHeaderRight = useCallback(() => <EarnHeaderRight />, []);
  return (
    <Page fullPage>
      <Page.Header
        title={intl.formatMessage({
          id: ETranslations.global_my,
        })}
            ...
            <YStack p="$4" gap="$6">
              <XStack position="relative">
                ...
                >
                  <SizableText size="$headingMd">
                    {intl.formatMessage({
                      id: ETranslations.my_total,
                    })}
                  </SizableText>
                  <Icon marginLeft="$1" name="EyeOutline" color="$bgReverse" />
                </XStack>
                ...
                >
                  <SizableText size="$headingMd">
                    {intl.formatMessage({
                      id: ETranslations.my_details,
                    })}
                  </SizableText>
                  <Icon name="ArrowRightOutline" color="$bgReverse" size="$4" />
                </XStack>
              </XStack>

              <YStack alignItems="center">
                <SizableText size="$heading5xl">99.1026</SizableText>
              </YStack>
              ...
              <XStack justifyContent="center" gap="$12">
                <XStack gap="$1" alignItems="center">
                  ...
                  <SizableText size="$bodyMdMedium">
                    {intl.formatMessage({
                      id: ETranslations.my_history,
                    })}
                  </SizableText>
                  <Icon name="ArrowRightOutline" size="$4" />
                </XStack>
                <XStack gap="$1" alignItems="center">
                  <Image
                    size="$4"
                    source={require('../../../assets/manage-wallet.png')}
                  />
                  <SizableText size="$bodyMdMedium">
                    {intl.formatMessage({
                      id: ETranslations.my_wallet,
                    })}
                  </SizableText>
                  <Icon name="ArrowRightOutline" size="$4" />
                </XStack>
          ...
          {INTRODUCTION_ITEMS.map((item, index) => (
            ...
            >
              <XStack alignItems="center">
                <YStack p="$2">
                  <Icon name={item.icon} color="$bgReverse" />
                </YStack>
                <YStack gap="$1.5">
                  <SizableText color="$bgReverse" size="$bodyMdMedium">
                    {item.title}
                  </SizableText>
                </YStack>
              </XStack>
              <YStack>
                <Icon name="ArrowRightOutline" color="$iconSubdued" />
              </YStack>
            </XStack>
          ))}
        </YStack>
