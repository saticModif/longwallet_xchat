/*
 * @Author: baoJT
 * @Date: 2025-01-12 02:00:13
 * @LastEditTime: 2025-01-13 00:56:11
 */
...
import { SuggestedView, DappsView } from './SuggestedView';
...
export function SuggestedAndExploreSection({
  ...
  return (
    ...
    >
      ...
      <DappsView suggestedData={dAppData?.hotdapps?.concat(dAppData?.mydapps || []) || []} handleOpenWebSite={handleOpenWebSite} />
      <DashboardSectionHeader>
        <DashboardSectionHeader.Heading
          key="suggested"
          selected={!isExploreView}
          onPress={() => setIsExploreView(false)}
        >
         {intl.formatMessage({ id: ETranslations.explore_market_exploration })}
        </DashboardSectionHeader.Heading>
        {/* <DashboardSectionHeader.Heading
          key="explore"
          selected={isExploreView}
